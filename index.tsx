...
class PINCode extends React.PureComponent<IProps, IState> {
  ...
  constructor(props: IProps) {
    ...
    AsyncStorage.getItem(this.props.timePinLockedAsyncStorageName || timePinLockedAsyncStorageNameDefault)
      .then((val) => {
  ...
  render() {
    ...
    return (
      <View style={[styles.container, styleMainContainer]}>
        ...
        {(pinStatus === PinResultStatus.locked || this.state.internalPinStatus === PinResultStatus.locked || this.state.pinLocked) &&
...
export function resetPinCodeInternalStates(pinAttempsStorageName?: string, timePinLockedStorageName?: string) {
