...
Async storage uses the [react-native-async-storage](https://github.com/react-native-async-storage/react-native-async-storage) library which has to be linked
